...
public interface MenuRepository extends MongoRepository<MenuEntity, String> {
  ...
  Optional<List<String>> findRestaurantIdsByItemsName(String itemName);

  Optional<List<String>> findRestaurantIdsByItemsAttributesContainingIgnoreCase(String searchString);
